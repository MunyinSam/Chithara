		...
		<div className="min-h-screen bg-white text-gray-900">
			...
			<section className="relative flex flex-col items-center justify-center text-center px-6 py-40 overflow-hidden">
				...
				<div className="relative z-10 flex flex-col items-center">
					<Badge
						variant="secondary"
						className="mb-4 uppercase tracking-wide text-indigo-400 bg-white/10 border-white/20 text-xs"
					>
						AI Music Generation
					</Badge>
					...
					<p className="text-xl text-gray-300 max-w-xl mb-10 leading-relaxed">
						Describe a feeling, a moment, or a vibe. Chithara uses
						AI to generate original songs from your prompts —
						instantly.
					</p>
			...
			<section className="relative flex flex-col items-center text-center px-6 py-32 overflow-hidden">
				...
				<div className="relative z-10 flex flex-col items-center">
					...
					<a
						...
						className={cn(
							buttonVariants({ size: 'lg' }),
							'bg-indigo-600 hover:bg-indigo-700 text-white px-10'
						)}
					>
