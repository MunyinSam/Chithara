...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-9^5=fm@4ob&v26&$oqt%j(ztn1o7ap(9m+8#bqb%_$u3vvn7p%')
...
if os.getenv('DB_HOST'):
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'chithara'),
            'USER': os.getenv('DB_USER', 'chithara'),
